...
The research_project was an exploration into stacking segmentation techniques in order to track contiguous lines in images. Though interesting, it wasn't particularly effective. Perhaps it can be improved with more tuning and techniques.
